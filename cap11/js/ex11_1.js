...
const respCavalo = document.getElementById("outCavalo")
...
frm.btResumo.addEventListener("click", () => {
  ...
  let resposta = `Nº Cavalo${".".repeat(12)} R$ Apostado\n${"-".repeat(35)}\n`
...
frm.btGanhador.addEventListener("click", () => {
  ...
  const total = apostas.reduce((a, aposta) => a + aposta.valor, 0)
